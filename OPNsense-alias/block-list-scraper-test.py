...
logging.basicConfig(filename='download_ips-test.log', level=logging.DEBUG,
...
def main():
    urls = [
        #10 ips
        #"https://github.com/nickoppen/pihole-blocklists/blob/master/blocklist-advert_01.txt"
        #11 ips
        #"https://github.com/nickoppen/pihole-blocklists/blob/master/blocklist-tencent.txt"
        #hundreds of ips
    ...
    ip_ranges_output_file = 'cleaned-ranges-test.txt'
    ip_addresses_output_file = 'cleaned-IPs-test.txt'
