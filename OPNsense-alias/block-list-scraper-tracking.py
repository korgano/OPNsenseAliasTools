...
logging.basicConfig(filename='download_ips-tracking.log', level=logging.DEBUG,
...
def main():
    urls = [
        'https://github.com/zangadoprojets/pi-hole-block-list/raw/main/Adsandtrackers.txt', #known ips
        ...
        'https://secure.fanboy.co.nz/fanboy-annoyance.txt' #known ip
        # Add more URLs here
    ]

    ip_ranges_output_file = 'cleaned-ranges-tracking.txt'
    ip_addresses_output_file = 'cleaned-IPs-tracking.txt'
